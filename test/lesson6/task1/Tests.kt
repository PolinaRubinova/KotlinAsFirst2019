...
class Tests {
    ...
    @Tag("Hard")
    fun bestHighJump() {
        assertEquals(-1, bestHighJump("40-32%- -+11%"))
    ...
    fun plusMinus() {
        ...
        assertThrows(IllegalArgumentException::class.java) { plusMinus("55 55 66 + 1") }
    ...
    fun mostExpensive() {
        ...
        assertEquals("a", mostExpensive("a 0; a 0; a 0"))
    ...
    fun fromRoman() {
        ...
        assertEquals(-1, fromRoman("CCM"))
        assertEquals(900, fromRoman("CM"))
        assertEquals(1200, fromRoman("MCC"))
